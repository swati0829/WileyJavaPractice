...
public class CurrencyConverter {
	...
	public static void main(String[] args) {
		...
		System.out.println("4 Pound"); 	//Added one more currency : Pound
	...
	public static void Ruppe_to_other(double amt) {
		...
		System.out.println("1 Ruppe = " + 0.0097 + " Pound");
		System.out.println();
	...
	public static void Pound_to_other(double amt) {
		System.out.println("1 Pound = " + 102.71 + " Ruppe");
		System.out.println();
		System.out.println(amt + " Pound = " + (amt * 102.71) + " Ruppe");
		System.out.println();
		...
		System.out.println("1 Pound = " + 1.14 + " Euro");
		System.out.println();
		System.out.println(amt + " Pound = " + (amt * 1.14) + " Euro");
